		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Practice",
									"targetURL": "#pracproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pracproject1-display": {
								"semanticObject": "pracproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pracproject1",
									"url": sap.ui.require.toUrl("pracproject1")
								}
							}
						}
					}
